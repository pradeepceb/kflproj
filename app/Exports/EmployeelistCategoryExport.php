...
class EmployeelistCategoryExport implements FromCollection, WithHeadings, WithEvents
{
    protected $data;
    protected $slno;
    protected $Healper;
    ...
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('A2:I2')
                ...
                ->getStartColor()
                ->setARGB('f0f8ff');
            $event->sheet->mergeCells('A2:I2')->setCellValue('A2', "EMPLOYEES LIST(Category Wise)
            ");
            ...
            $event->sheet->setCellValue('D3', "EMPLOYEE CODE");
            ...
            $event->sheet->setCellValue('I'.$i, $this->Healper->GetModifydate(@$val->DOJ));
