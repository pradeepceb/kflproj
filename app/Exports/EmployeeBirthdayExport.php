...
class EmployeeBirthdayExport implements FromCollection, WithHeadings, WithEvents
{
    protected $data;
    protected $slno;
    protected $Healper;
    ...
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('A2:I2')
                ...
                ->getStartColor()
                ->setARGB('f0f8ff');
            $event->sheet->mergeCells('A2:I2')->setCellValue('A2', "BIRTHDAY FALL REPORT");
            ...
            $event->sheet->setCellValue('I3', "BIRTH DAY");
            $i=4;
            ...
            $event->sheet->setCellValue('I'.$i, $this->Healper->GetModifydateDaywise(@$val->DOB));
            $i++;
            }
        },
    ];
