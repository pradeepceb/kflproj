...
class EmployeeRetirementDueExport implements FromCollection, WithHeadings, WithEvents
{
    protected $data;
    protected $slno;
    protected $Healper;
    ...
    return [
        AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('A2:J2')
                ...
                ->getStartColor()
                ->setARGB('f0f8ff');
            $event->sheet->mergeCells('A2:J2')->setCellValue('A2', "RETIREMENT DUE REPORTS");
            ...
            $event->sheet->setCellValue('G3', "DATE OF BIRTH");
            $event->sheet->setCellValue('H3', "JOINING DATE");
            $event->sheet->setCellValue('I3', "RETIREMENT DATE");
            $event->sheet->setCellValue('J3', "EMPLOYEE CATEGORY");
            $i=4;
            ...
            $event->sheet->setCellValue('I'.$i, $this->Healper->GetModifydate(@$val->retirement_date));
