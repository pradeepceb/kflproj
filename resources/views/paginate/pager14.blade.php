...
<nav aria-label="Page navigation example">
    <ul class="pagination nav justify-content-center">
        ...
        @if(!isset($_GET['page']))
        <li class="page-item active"><a class="page-link" href="employee-master-data-report">All</a></li>
        @else 
        <li class="page-item"><a class="page-link" href="employee-master-data-report">All</a></li>
        @endif

        @else

        @if(!isset($_GET['page']))
        <li class="page-item active"><a class="page-link" href="employee-master-data-report?{{ substr($url, 1) }}">All</a></li>
        @else
        <li class="page-item"><a class="page-link" href="employee-master-data-report?{{ substr($url, 1) }}">All</a></li>
        @endif 
        ...
        @if ($i >= $paginator->currentPage() - 2 && $i <= $paginator->currentPage() + 2)
            ...
            @if(isset($_GET['page']))
            <li class="page-item active"><a class="page-link" href="employee-master-data-report?page=1{{ $url }}">{{ $i }}</a></li>
            @else
            <li class="page-item"><a class="page-link" href="employee-master-data-report?page=1{{ $url }}">{{ $i }}</a></li>
            @endif
