                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-4" style="margin:0px;padding:0px;">
                        <div class="col-md-12">
                          <select class="form-control  col-md-6 float-left" name="InTime_hour" required>
                            @for ($mm=1; $mm<=24; $mm++)
                            <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                            @endfor
                          </select>
                          <select class="form-control  col-md-6" name="InTime_minute" required>
                        ...
                        <div class="col-md-4" style="margin:0px;padding:0px;">
                          <div class="col-md-12">
                            <select class="form-control  col-md-6 float-left" name="outtime_hour" required>
                              @for ($mm=1; $mm<=24; $mm++)
                              <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                              @endfor
                            </select>
                            <select class="form-control  col-md-6" name="outtime_minute" required>
                              <option value="00">00</option>
                              <option value="30">30</option>
                            </select>
                          </div>
                ...
                <div class=" row mt-2">
                  <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin:0px;padding:0px;">
                          <div class="col-md-12">
                            <select class="form-control  col-md-6 float-left" name="Rstin_hour" required>
                              @for ($mm=1; $mm<=24; $mm++)
                              <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                              @endfor
                            </select>
                            <select class="form-control  col-md-6" name="Rstin_minute" required>
                              <option value="00">00</option>
                              <option value="30">30</option>
                            </select>
                          </div>
                        ...
                        <div class="col-md-4" style="margin:0px;padding:0px;">
                          <div class="col-md-12">
                            <select class="form-control  col-md-6 float-left" name="RstOut_hour" required>
                              @for ($mm=1; $mm<=24; $mm++)
                              <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                              @endfor
                            </select>
                            <select class="form-control  col-md-6" name="RstOut_minute" required>
                              <option value="00">00</option>
                              <option value="30">30</option>
                            </select>
                          </div>
                ...
                <div class=" row mt-2">
                  <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4" style="margin:0px;padding:0px;">
                          <div class="col-md-12">
                            <select class="form-control  col-md-6 float-left" name="Rsthrs_hour" required>
                              @for ($mm=1; $mm<=24; $mm++)
                              <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                              @endfor
                            </select>
                            <select class="form-control  col-md-6" name="Rsthrs_minute" required>
                              <option value="00">00</option>
                              <option value="30">30</option>
                            </select>
                          </div>
                        ...
                        <div class="col-md-4" style="margin:0px;padding:0px;">
                          <div class="col-md-12">
                            <select class="form-control  col-md-6 float-left" name="Wrkhrs_hour" required>
                              @for ($mm=1; $mm<=24; $mm++)
                              <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                              @endfor
                            </select>
                            <select class="form-control  col-md-6" name="Wrkhrs_minute" required>
                              <option value="00">00</option>
                              <option value="30">30</option>
                            </select>
                          </div>
                ...
                <div class=" row mt-2">
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4" style="margin:0px;padding:0px;">
                        <div class="col-md-12">
                          <select class="form-control  col-md-6 float-left" name="HdStart_hour" required>
                            @for ($mm=1; $mm<=24; $mm++)
                            <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                            @endfor
                          </select>
                          <select class="form-control  col-md-6" name="HdStart_minute" required>
                            <option value="00">00</option>
                            <option value="30">30</option>
                          </select>
                        </div>
                      ...
                      <div class="col-md-4" style="margin:0px;padding:0px;">
                        <div class="col-md-12">
                          <select class="form-control  col-md-6 float-left" name="HdEnd_hour" required>
                            @for ($mm=1; $mm<=24; $mm++)
                            <option value="<?= $mm ?>" @if($mm == '6') selected @endif ><?= $mm ?></option>
                            @endfor
                          </select>
                          <select class="form-control  col-md-6" name="HdEnd_minute" required>
                            <option value="00">00</option>
                            <option value="30">30</option>
                          </select>
                        </div>
