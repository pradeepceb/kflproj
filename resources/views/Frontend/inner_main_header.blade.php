            ...
            <nav id="topbar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="index-2.html">
                            <img src="https://www.polosoftech.com/staging/samaja-tms-live/public/assets/img/logo3.png" class="navbar-logo" alt="logo">
                        </a>
                    </li>
              ...
              <!--       
                    ...
                    <li class="menu single-menu">
                        <a href="personnel-management-system.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
