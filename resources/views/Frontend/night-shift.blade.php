              ...
              <div id="general-info" class="section general-info">
                <div class="info">
                  ...
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Night Shift Allowance</h5>
                  </div>
                  <div class="modal-body p-0">
                    <form action="{{url('/')}}/night-shift-data" method="post">
                      {{csrf_field()}}
                      <div class="row m-0 p-2">
                        <label class="col-md-2"> Date of report</label>
                        <div class="col-md-3">
                      ...
                      <div class="row m-0 p-2">
                        <div class="form-check m-2">
                          <input class="form-check-input" type="radio" id="radioEmpCode" name="employeeSort" value="1" onclick="empCodeWiseNight();" checked>
                          <label class="form-check-label" for="radioEmpCode">Emp Code Wise</label>
                        </div>

                        <div class="form-check m-2">
                          <input class="form-check-input" type="radio" id="radioEmpCode" value="2" name="employeeSort" onclick="departmentWiseNight();">
...
<script>
  ...
  function empCodeWiseNight(){
    $("#empCodeWise").show();
    $("#departmentWise").hide();
  }

  function departmentWiseNight(){
    $("#departmentWise").show();
    $("#empCodeWise").hide();
  }
</script>
