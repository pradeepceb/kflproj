              ...
              <div id="general-info" class="section general-info">
                <div class="info">
                  ...
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Monthly Late Report</h5>
                  </div>
                  <div class="modal-body p-0">
                    <form action="{{url('/')}}/late-arrival-data" method="post">
                      {{csrf_field()}}
                      ...
                      <div class="row m-0 p-2">
                        <div class="form-check m-2">
                          <input class="form-check-input" type="radio" id="radioEmpCode" name="employeeSort" value="1" onclick="empCodeWiseLate();" checked>
                          <label class="form-check-label" for="radioEmpCode">Emp Code Wise</label>
                        </div>

                        <div class="form-check m-2">
                          <input class="form-check-input" type="radio" id="radioEmpCode" value="2" name="employeeSort" onclick="departmentWiseLate();">
...
<script>
  ...
  function empCodeWiseLate(){
    $("#empCodeWise").show();
    $("#departmentWise").hide();
  }

  function departmentWiseLate(){
    $("#departmentWise").show();
    $("#empCodeWise").hide();
  }
</script>
