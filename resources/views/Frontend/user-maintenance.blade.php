...
@endif
 ...
 <script>
    ...
    <form id="general-info" class="section general-info" style="height: 570px;"  action="{{url('/')}}/userData" method="post" autocomplete="on">
    {!! csrf_field() !!}  
...
<input type="hidden" id="login_email" name="login_email" value="{{ Auth::user()->email }}">
                        ...
                        <div class="col-lg-6">
                            ...
                            <label>User Id</label>
                            <input type="email" class="form-control  mb-4" name="email"  id="email" required autocomplete="off">
                        </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="password" class="form-control mb-4" name="" value="" id="password1" required autocomplete="off">
                        </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                            <label>Confirm Password</label>
                            <input type="password" class="form-control mb-4" name="confirm" value="" id="password2" required autocomplete="off">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="date" class="form-control mb-4"  name="expiary_date" value="" id="expiary_date" required autocomplete="off">
