...
if(isset($_GET['active_type'])){
      ...
      $active_type= "all";
        ...
        <h5 class="data-heading1 pt-0">The Samaj<span>Report run on: {{ $time }}</span></h5>
                                            <h3 class="data-heading p-0">RETIREMENT DUE REPORTS</h3>
                    <div style="text-align: right; margin-top:-35px; padding-bottom:7px;">
                        <a href="{{ url('/') }}/retirement-due-reports-print<?php echo $curl; ?>" class="btn btn-primary" target="_blank" id="print_btn" ><i class="fa fa-print"></i> Print</a>

                    <a class="btn btn-primary" target="_blank" id="xl_btn" href="{{ url('/') }}/retirement-due-reports-xl<?php echo $curl; ?>" >Excel</a>  
    ...
    <label>To Date:</label>
        ...
        <table style="margin-left:10px;">
            <tr>
                ...
                <td><a href="{{ url('/') }}/retirement-due-reports" class="btn btn-info "><i class="fa fa-refresh" aria-hidden="true"></i></a></td>
            </tr>
        </table>
    </form>
                                        </div>
    ...
    <table class="table" id="myTable" width="100%" >
            ...
            @endforeach  
                    ...
                    <tfoot>
                        <tr>
                            <td align="right" colspan="10">{{ $employee_list->links('paginate.pager9') }} </td>
                        </tr>
                    </tfoot>
                                        </table>
