...
.cer i{
    margin-top: 5px;
                ...
                <ul class="list-unstyled menu-categories nav justify-content-center" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="{{url('/user-maintenance')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
 ...
 @endif
         ...
         action="{{url('/')}}/edit_login_access"  method="post" autocomplete="on">
                 {!! csrf_field() !!} 
             <div class="info">
                 <h6 class="">EDIT USER PROFILE</h6>
                     <div class="col-lg-7 mx-auto user-maintenance">
                         <div class="row">
                            
                             <div class="col-lg-12 text-center login-type">
     <h5>USER GROUP</h5>
     @foreach($type as $ky=>$val)
     <input type="radio"  name="user_name" value="{{$val->user_type}}" <?php if($val->user_type==$userdata->role){echo "checked";} else{ echo "disabled";} ?>>
     ...
     @endforeach 
                             ...
                             <div class="col-lg-6">
                                 ...
                                 <label>User Id</label>
                                 <input type="text"  class="form-control" id="email_id1" name="email_id1" required value="{{ $userdata->email }}">
<input type="hidden" id="id" name="user_sql_id1" value="{{ $userdata->id }}">
<input type="hidden" id="login_id" name="login_id" value="{{ $userdata->id }}">
<input type="hidden" id="login_role" name="login_role" value="{{ $userdata->role }}">
<input type="hidden" id="login_email" name="login_email" value="{{$userdata->email }}">
                             </div>
                             </div>
                             <div class="col-lg-6">
                                 <div class="form-group">
                                 <label for="fullName">Status</label><br>
                               <select class="form-control" id="status" name="status1" required>
                             ...
                             <div class="col-lg-12">
                                 ...
                                 <input type="date" class="form-control mb-4"  name="expiary_date1" value="{{$userdata->expiary_date }}" id="expiary_date" required >
                             ...
                             <div class="offset-lg-2 col-lg-8 text-center">
                                 ...
                                 <a href="{{ url('/') }}/user-maintenance" class="btn btn-danger mb-2" style="margin-top: 10px;">Cancel</a>
                             </div>
