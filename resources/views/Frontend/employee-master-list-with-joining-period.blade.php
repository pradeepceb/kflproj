...
?>
      ...
      <div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center" >
        ...
        <h5 class="data-heading1 pt-0" >The Samaj<span>Report run on: {{ $time }}</span></h5>
                                            <h3 class="data-heading p-0">EMPLOYEES MASTER LIST(With Joining Period)
                                            </h3>
                                            <div style="text-align: right; margin-top:-35px; padding-bottom:7px;">
   <a href="{{ url('/') }}/employee-master-list-with-joining-period-print<?php echo $curl; ?>" class="btn btn-primary" target="_blank" id="print_btn" ><i class="fa fa-print"></i> Print</a>
                      
   <a class="btn btn-primary" target="_blank" id="xl_btn" href="{{ url('/') }}/employee-master-list-with-joining-period-xl<?php echo $curl; ?>" >Excel</a>
                                        </div>
                                        </div>
...
@endphp         
         <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="padding-right:0px !important;padding-left:0px !important;">
            ...
            <input type="date" name="from" value="{{ $from }}" id="from" class="col-lg-1 form-control"  />
            &nbsp;&nbsp;
            <label>DOJ To:</label>
            <input type="date" name="to" id="to" value="{{ $to }}" class="col-lg-1 form-control"  /> 
            &nbsp;&nbsp;
            <table style="margin-left:10px;">
                <tr>
                    <td><button type="submit" class="btn btn-primary report-btn" value="">Search</button></td>
                    <td><a href="{{ url('/') }}/employee-master-list-with-joining-period" class="btn btn-info "><i class="fa fa-refresh" aria-hidden="true"></i></a></td>
                </tr>
            </table>
...
<tfoot>
                    <tr>
                        <td align="right" colspan="15">{{ $employee_list->links('paginate.pager18') }} </td>
                    </tr>
                </tfoot>
            </table> 
        </div>
      ...
      .page-count:after{counter-increment:page;content:"Page" counter(page) " of " counter(pages);}
      </style> 
       style = style + 'body{counter-reset:page;}';
                style = style + '.page-count:after{counter-increment:page;content:"Page" counter(page) " of " counter(pages);}';
      @page { size: A4 portrait; margin-top: 1.2cm; margin-bottom: 1.2cm; margin-left: 1.2cm; margin-right: 1.2cm; background-image: url('../../images/logo_small.png'); background-repeat: no-repeat; background-position: 40px 10px; @bottom-center { content: counter(page); } } 
      style = style + "@page { size: A4 portrait; }";
