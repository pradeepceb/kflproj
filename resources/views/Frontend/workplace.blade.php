      ...
      <div class="account-content">
        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                ...
                <div class="info">
                  <div class="row">
                    <div class="col-md-12 text-left p-0">
                      <h6 class="">SUB DEPARTMENT / WORK PLACE MASTER</h6>
                    </div>
                    ...
                    <div class="col-lg-12 mx-auto">
                      <table class="table table-bordered table-hover text-center">
                        <thead>
                          <tr>
                            <th>Id</th>
                            <th>SUB DEPARTMENT / WORK PLACE NAME</th>
                            <th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                          @foreach($workplace_master_view as $ky=>$val)
                          <tr>
                            <td>{{$val->id}}</td>
                            <td>{{$val->workplace_name}}</td>
                            <td>
                      ...
                      <br>
                      {{ $workplace_master_view->appends(Request::all())->links() }}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
              <form id="general-info" class="section general-info" action="{{url('/')}}/add-sub-departments"
                method="post">
                {!! csrf_field() !!}
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Add New Sub Department / Work Place</h5>
                  ...
                  <div class="modal-body pb-0">
                    <div class="col-12 py-2 ">
                      <div class="row">
                        <label class="col-md-4" for="">Sub Department / Workplace Name</label>
                        <div class="col-md-8">
                          <input type="text" class="form-control" name="workplace_name" required="" disabled>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Edit Sub Department / Work Place Details</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form action="{{url('/')}}/Update_sub-departments" method="post">
                    {{csrf_field()}}
                    <div class="form-group">
                      <input type="hidden" class="form-control" name="work_id" id="workplace_id"
       ...
       $('.editbtn').on('click' ,function(){
         ...
         $tr = $(this).closest('tr');
          ...
          console.log(data);
          $('#workplace_id').val(data[0]);
          $('#workplace_name').val(data[1]);
