                                ...
                                <div class="widget-header">
                                    <div class="row">
                                    	<div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center">
                                            ...
                                            <h3 class="data-heading">EMPLOYEE MONTHLY  REMUNERATION DETAIL REPORT</h3>
                                        </div>
                                    ...
                                    <div class="table-responsive" style="margin-top: 5px;">
                                       <table class="table mb-4">
                                          <thead>
                                                ...
                                                <th class="t-th" colspan="13" style="horizontal-align : middle;text-align:center;  ">For Month Of Oct 2020</th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="t-th" scope="col">Vp</th>
                                                <th class="t-th" scope="col">PP_1</th>
                                                <th class="t-th" scope="col">PP_2</th>
                                                <th class="t-th" scope="col">DA</th>
                                                <th class="t-th" scope="col">AI</th>
                                                <th class="t-th" scope="col">HRA</th>
                                                <th class="t-th" scope="col">TA</th>
                                                <th class="t-th" scope="col">NA</th>
                                                <th class="t-th" scope="col">Special Allowance</th>
                                                <th class="t-th" scope="col">Other Allowance</th>
                                                <th class="t-th" scope="col">MA</th>
